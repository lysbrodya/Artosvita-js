...
<div type="button" class="mob-menu__border">
  ...
  `}const m=location.hostname.includes("github.io")?"/Artosvita-js":"",E=`
...
`;function $(){document.body.insertAdjacentHTML("beforeend",E);const e=document.querySelector(".backdrop"),t=document.querySelector(".mob-menu"),n=document.querySelector(".mobile-menu-close-button");if(!e||!t||!n)return;t.addEventListener("click",o),n.addEventListener("click",o),e.addEventListener("click",s=>{s.target===e&&o()});function o(){e.classList.toggle("is-hidden"),document.body.classList.toggle("no-scroll")}}const v=location.hostname.includes("github.io")?"/Artosvita-js":"";async function S(){return(await fetch(`${v}/reviews.json`)).json()}function A(e){return e.map(t=>`<li class="review-card">
...
`;function O(){document.body.insertAdjacentHTML("beforeend",T);const e=document.querySelector("[data-modal]"),t=document.querySelectorAll("[data-modal-open]"),n=document.querySelector("[data-modal-close]");if(!e||!t||!n)return;t.forEach(s=>{s.addEventListener("click",o)}),n.addEventListener("click",o),e.addEventListener("click",s=>{s.target===e&&o()});function o(){e.classList.toggle("is-hidden"),document.body.classList.toggle("no-scroll")}}x();M();B();H();document.addEventListener("DOMContentLoaded",()=>{$()});document.addEventListener("DOMContentLoaded",()=>{O()});
