...
`;function A(){document.body.insertAdjacentHTML("beforeend",E);const e=document.querySelector(".backdrop"),t=document.querySelector(".mob-menu"),n=document.querySelector(".mobile-menu-close-button");if(!e||!t||!n)return;t.addEventListener("click",o),n.addEventListener("click",o),e.addEventListener("click",s=>{s.target===e&&o()});function o(){e.classList.toggle("is-hidden"),document.body.classList.toggle("no-scroll")}}const g=location.hostname.includes("github.io")?"/Artosvita-js":"";async function S(){return(await fetch(`${g}/reviews.json`)).json()}function j(e){return e.map(t=>`<li class="review-card">
...
`;function q(){document.body.insertAdjacentHTML("beforeend",O);const e=document.querySelector("[data-modal]"),t=document.querySelectorAll("[data-modal-open]"),n=document.querySelector("[data-modal-close]");if(!e||!t||!n)return;t.forEach(s=>{s.addEventListener("click",o)}),n.addEventListener("click",o),e.addEventListener("click",s=>{s.target===e&&o()});function o(){e.classList.toggle("is-hidden"),document.body.classList.toggle("no-scroll")}}const c=location.hostname.includes("github.io")?"/Artosvita-js":"";function C(){const e=document.getElementById("tg-bots");e&&(e.innerHTML=`      
